...
func axeman():
	for i in range(len(script_dict["axe man"])):
...
func doubleman():
	for i in range(len(script_dict["double jump man"])):
...
func hoverman():
	for i in range(len(script_dict["hover man"])):
...
func tummyhurtman():
	for i in range(len(script_dict["tummy hurt man"])):
...
func windowman():
	for i in range(len(script_dict["window man"])):
...
func doctor():
	for i in range(len(script_dict["doctor"])):
